...
import {
  areasInvolved as mdAreasInvolved,
  projectTechnologies as mdProjectTechnologies,
} from "@/app/projects/distributed-md-platform/page-data";
import {
  areasInvolved as watchlistAreasInvolved,
  projectTechnologies as watchlistProjectTechnologies,
} from "@/app/projects/multi-exchange-watchlist/page-data";
...
export const technologiesData = {
  ...
  PM2: {
    description:
      "PM2 is a process manager for Node.js applications that allows for easy scaling and management.",
  ...
  Websocket: {
    description: "Websocket is a protocol for real-time communication.",
    icon: "https://websocket.org/images/logo.svg",
  },
  AgGrid: {
    description: "Industry standard Data Grid for Enterprise Applications.",
    icon: "https://www.ag-grid.com/images/logo.svg",
  },
};
...
export default [
  {
    ...
    skills: mdAreasInvolved,
    technologies: mdProjectTechnologies,
    bigImage: "/md-platform/infra.png",
    description:
      "High-performance, geographically distributed infrastructure delivering ultra-low latency cryptocurrency market data through a unified API.",
    challenges:
  ...
  {
    slug: "multi-exchange-watchlist",
    title: "Multi-Exchange Cryptocurrency Watchlist",
    skills: watchlistAreasInvolved,
    technologies: watchlistProjectTechnologies,
    bigImage: "/streaming-watchlist.png",
    description:
      "Real-time price monitoring application providing aggregated market data across exchanges with granular exchange-level breakdown for comprehensive price discovery.",
    challenges:
  ...
  },
  {
    ...
    disabled: true,
    title: "Cross-Network Portfolio Tracker",
    skills: watchlistAreasInvolved,
    technologies: watchlistProjectTechnologies,
